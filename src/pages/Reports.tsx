      ...
      <Card className="border-emerald-200">
        ...
        <CardContent>
          <p className="text-xs text-muted-foreground mb-4">
            Договоры сбережений, действующие в выбранном периоде. Колонки: ФИО, телефон, организация, номер договора,
            даты открытия и окончания, ставка, вариант выплаты процентов, сумма сбережений, остаток основного долга к
