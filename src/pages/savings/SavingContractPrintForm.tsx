...
<p class="justify">${orgName}, именуемый в дальнейшем «Организация», в лице ${directorPos} ${directorFio}, действующего на основании Устава, с одной стороны и <b>${memberFio}</b>, именуемый в дальнейшем «Пайщик», а вместе именуемые «Стороны», заключили настоящий договор о нижеследующем:</p>

<p class="bold center">1. Предмет договора</p>
<p class="justify">1.1. В силу настоящего Договора Пайщик передает, а Организация принимает денежные средства (далее – Паевой взнос) в размере и на условиях, предусмотренных настоящим Договором, и обязуется возвратить сумму паевого взноса и выплатить доход в соответствии с условиями настоящего Договора и Положения по формированию и использованию паевого фонда Организации.</p>
...
<p class="justify">1.8. Доход на паевые взносы устанавливается согласно действующих тарифов Организации согласно Приложения № 1.</p>
...
<p class="justify">2.2.1. Продлить договор Паевого взноса на тот же срок, если по окончании договора он не будет истребован в установленном пунктом 2.1.1 порядке.</p>
...
<p class="justify">3.3. В случае досрочного расторжения договора Организация производит перерасчет начисленного дохода по ставке 1% годовых, а ранее выплаченный либо причисленный путем капитализации доход сверх пересчитанного удерживается из суммы остатка паевого взноса.</p>
