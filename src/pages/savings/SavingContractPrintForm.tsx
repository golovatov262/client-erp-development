...
<p class="justify">1.8. Доход на паевые взносы устанавливается в размере ${detail.rate != null ? detail.rate + '%' : '___________'} согласно действующих тарифов Организации согласно Приложения № 1 к Положению о порядке формирования и использования имущества потребительского кооператива корпоративного обслуживания «Эксперт Финанс».</p>
...
<p class="justify">2.2.2. При продлении договора в соответствии с пунктом 2.2.1 применить тарифную программу, действующую в ${orgName} на дату продления договора.</p>
